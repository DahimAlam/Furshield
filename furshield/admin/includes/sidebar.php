...
<aside class="admin-sidebar">
  ...
  <nav class="nav flex-column">
    ...
    <a class="nav-link <?php echo $active(['brands.php']); ?>" href="<?php echo BASE; ?>/admin/pages/content/brands.php"><i class="bi bi-award"></i><span>Brands</span></a>
    ...
    <a class="nav-link <?php echo $active(['stories.php']); ?>" href="<?php echo BASE; ?>/admin/pages/content/stories.php"><i class="bi bi-bookmark-heart"></i><span>Stories</span></a>
    ...
    <a class="nav-link <?php echo $active(['gallery.php']); ?>" href="<?php echo BASE; ?>/admin/pages/content/gallery.php"><i class="bi bi-images"></i><span>Gallery</span></a>

    <div class="nav-section">Engagement</div>
    <a class="nav-link <?php echo $active(['newsletter.php']); ?>" href="<?php echo BASE; ?>/admin/pages/engagement/newsletter.php">
      <i class="bi bi-envelope-paper-heart"></i><span>Newsletter</span>
      <?php if($newsletterCount): ?><span class="badge-dark"><?php echo $newsletterCount; ?></span><?php endif; ?>
    </a>
